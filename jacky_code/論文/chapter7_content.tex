...
Overall, EABR provides a practical service recovery approach for multi-beam LEO satellite systems under the GS EPFD constraint. By using precomputed beam relation information and neighboring helper satellites, the proposed framework improves service continuity without relying on high-complexity global optimization in every time slot. Therefore, EABR achieves a better balance between EPFD compliance, user satisfaction, and implementation complexity.
